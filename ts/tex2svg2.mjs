...
// import {dependencies} from 'mathjax-full/components/src/dependencies.js'

import {texRead, svgOutput} from "./readSync.mjs";
...
const texContent = texRead(argv.input) || ''
...
init({
    ...
    MathJax.tex2svgPromise(texContent, {
        ...
        svgOutput(MathJax, node, argv.container, argv.styles, argv.css, CSS, argv.output)
    })
    // console.log(MathJax.config.startup.adaptor)
    // console.log(MathJax.config.startup)
    // console.log(MathJax._.input.tex)
    // console.log(MathJax._.input.tex_ts.TeX)
